      ...
      <div className="w-full min-h-screen md:w-1/2 flex flex-col justify-center p-8 md:px-20">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-400">Join the next generation of communication</p>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 text-slate-400 hover:text-slate-300 cursor-pointer"
                    >
